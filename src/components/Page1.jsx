    ...
    <div className="bg-[#002147] h-full w-full">
      <div className="flex flex-col items-center py-10">
        ...
        <div className="h-96 w-1/2 bg-red-50 rounded mt-20 flex gap-20 px-10 hover:shadow-2xl items-center justify-center">
          ...
          <Link to="/faculty" className="h-72 w-1/2 bg-[#FFB606] rounded cursor-pointer shadow-custom">
          ...
          <Link to="/students" className="h-72 w-1/2 bg-[#FFB606] rounded cursor-pointer shadow-custom">
