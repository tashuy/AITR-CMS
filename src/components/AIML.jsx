...
const AIML = () => {
  ...
  const tableHeaders = {
    ...
    Placement: ["id", "studentName","enrollmentNumber", "companyName", "jobRole", "branch", "placementType", "packageAmount", "joiningDate", "offerLetterPdf", "companyLocation", "interviewMode"],
