...
const AIML = () => {
  ...
  const tableHeaders = {
    ...
    Certificate:["STUDENT NAME", "ENROLLMENT NUMBER", "CERTIFICATE NAME", "CERTIFICATE TYPE", "ISSUED BY", "ISSUE DATE", "VALIDITY PERIOD", "GRADE OR SCORE", "CERTIFICATE DESCRIPTION", "MODE OF TRAINING", "RELATED COURSE OR PROGRAM", "CERTIFICATE STATUS", "VERIFIED", "CERTIFICATE LINK"]
,   Hackathon:["STUDENT NAME", "ENROLLMENT NUMBER", "EVENT NAME", "DATE", "TEAM NAME", "TEAM SIZE", "MENTOR NAME", "HACKATHON TYPE", "ORGANIZING BODY", "VENUE", "PROBLEM STATEMENT", "TECHNOLOGY USED", "PRIZE MONEY", "SPONSORING COMPANY", "POSITION", "PROJECT GITHUB LINK", "PROJECT DESCRIPTION", "CERTIFICATE STATUS", "CERTIFICATE LINK"],
    Placement: ["ID", "STUDENT NAME", "COMPANY NAME", "JOB ROLE", "BRANCH", "PLACEMENT TYPE", "PACKAGE AMOUNT", "JOINING DATE", "OFFER LETTER LINK", "COMPANY LOCATION", "INTERVIEW MODE"]
,   Internship: ["Student Name", "Enrollment Number", "Company Name", "Role", "Internship Type", "Stipend", "Duration", "Department", "Mentor Name", "Mentor Email", "Technologies Used", "Project Name", "Project Description", "Skills Gained", "Company Location", "Internship Status", "Start Date", "End Date", "Offer Letter Link", "Experience Letter Link", "Certificate Link"]
,   ResearchPaper: ["student_name", "title", "publication_date", "journal_name", "co_authors"],
    Sports: ["ID", "STUDENT NAME", "SPORT NAME", "ACHIEVEMENT", "EVENT DATE", "EVENT NAME", "EVENT LEVEL", "EVENT LOCATION", "POSITION", "CERTIFICATE LINK", "COACH NAME"]
,
  };
